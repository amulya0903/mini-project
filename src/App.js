  ...
  return (
    <div className="auth-container">
      <div className="login-container">
        ...
        <p class="register-link">Don't have an account? <Link to="/register">Register</Link></p>
      </div>
    </div>
  );
}
      ...
      <div className="register-container">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="button-container">
            ...
            <p class="register-link">Already registered?<Link to="/login" className="register-link">Login Here</Link></p>
          </div>
        </form>
      </div>
    </div>
      ...
      {product && (
        <>
          ...
          <div className='product-details'>
            ...
            <h4 className='product-rating'>☆ {product.rating.rate} ({product.rating.count} reviews)</h4>
            <h4 className='product-description'>Info:{product.description}</h4>
          </div>
          </>
        )}
      </div>
